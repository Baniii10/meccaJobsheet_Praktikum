...
// 1. Mendapatkan daftar kategori unik (unique category)
const uniqueCategories = [...new Set(products.map(p => p.category))];

// 2. Mendapatkan daftar brand unik (unique brand) - jika properti brand tersedia
const uniqueBrands = [...new Set(products.map(p => p.brand))];

// 3. Mendapatkan daftar tags unik (unique tags) menggunakan flatMap
